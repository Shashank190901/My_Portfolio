...
const EmailSection = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_itt8jvu', 'template_0yqlvh2', form.current, {
        publicKey: 'Yaoavs1YkSRLpf-_0',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Shashank190901">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/shashank-srivastava001/">
